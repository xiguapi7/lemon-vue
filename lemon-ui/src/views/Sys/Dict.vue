  ...
  <div class="page-container">
    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" :size="size">
        ...
        <el-form-item>
          <kt-button :label="$t('action.search')" @click="findPage(null)" icon="fa fa-search" perms="sys:dict:view"
                     type="primary"/>
        </el-form-item>
        <el-form-item>
          <kt-button :label="$t('action.add')" @click="handleAdd" icon="fa fa-plus" perms="sys:dict:add"
                     type="primary"/>
        </el-form-item>
      </el-form>
    </div>
    ...
    <kt-table :columns="columns" :data="pageResult"
              ...
              @handleEdit="handleEdit" permsDelete="sys:dict:delete" permsEdit="sys:dict:edit">
    </kt-table>
    <!--新增编辑界面-->
