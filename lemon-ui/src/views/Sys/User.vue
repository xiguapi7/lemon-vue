<template>
  <div class="page-container">
        ...
        <el-form-item>
          <el-button-group>
            <el-tooltip content="刷新" placement="top">
              <el-button @click="findPage(null)" icon="fa fa-refresh"></el-button>
            </el-tooltip>
    ...
    <!--表格内容栏-->
    <kt-table :columns="filterColumns" :data="pageResult"
              @findPage="findPage" @handleDelete="handleDelete"
              @handleEdit="handleEdit" permsDelete="sys:user:delete" permsEdit="sys:user:edit">
    </kt-table>
    <!--新增编辑界面-->
    <el-dialog :close-on-click-modal="false" :title="operation?'新增':'编辑'" :visible.sync="dialogVisible" width="40%">
      <el-form :model="dataForm" :rules="dataFormRules" :size="size" label-position="right" label-width="80px"
               ref="dataForm">
        ...
        <el-form-item label="角色" prop="userRoles" v-if="!operation">
          <el-select multiple placeholder="请选择" style="width: 100%;"
            ...
            <el-option :key="item.id" :label="item.remark"
